...
4. **O Expo CLI facilita o processo de criação e gerenciamento de projetos React Native.
- Execute o comando abaixo para instalar o Expo CLI globalmente:**npm install -g expo-cli

5. **Configuração do AsyncStorage:**
